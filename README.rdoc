...
* {System.Net.Http.MultipartFileStreamProvider}[http://msdn.microsoft.com/en-us/library/system.net.http.multipartfilestreamprovider.aspx] &rarr; TestableMultipartFileStreamProvider
* {System.Net.Http.MultipartFormDataStreamProvider}[http://msdn.microsoft.com/en-us/library/system.net.http.multipartformdatastreamprovider.aspx] &rarr; TestableMultipartFormDataStreamProvider
